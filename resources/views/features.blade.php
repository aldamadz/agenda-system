<x-layouts.auth>
    <div
        class="fixed inset-0 w-screen h-screen overflow-y-auto bg-white dark:bg-[#09090b] transition-colors duration-500 cursor-default selection:bg-indigo-100 dark:selection:bg-indigo-500/30">
        ...
        <div class="relative z-30 max-w-7xl mx-auto px-8 pt-10 flex justify-between items-center">
            <div class="flex items-center gap-2 group cursor-pointer" onclick="window.location.href='/'">
                <div
                    class="w-10 h-10 bg-zinc-900 dark:bg-white rounded-xl flex items-center justify-center transition-transform group-hover:rotate-6 shadow-lg">
                    <svg class="w-6 h-6 text-white dark:text-zinc-900" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
        ...
        <header class="relative z-20 pt-24 pb-20 px-8 max-w-5xl mx-auto text-center select-none">
            ...
            <p class="text-lg md:text-xl text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
                Panduan komprehensif mengenai kemampuan teknis dan operasional Agenda System untuk efisiensi tim Anda.
            </p>
        </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row gap-12 items-start">
                        <div class="flex-1">
                            <span class="text-indigo-600 font-bold text-sm">Modul 01</span>
                            <h3 class="text-3xl font-bold dark:text-white mt-2 mb-6">Monitoring & Visualisasi</h3>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8">
                                <div class="flex items-center gap-3 text-sm font-medium dark:text-zinc-300">
                                ...
                                <div class="flex items-center gap-3 text-sm font-medium dark:text-zinc-300">
                                    <div class="w-2 h-2 rounded-full bg-indigo-500"></div> Multi-User Filter (Manager)
                                </div>
                                <div class="flex items-center gap-3 text-sm font-medium dark:text-zinc-300">
                                    <div class="w-2 h-2 rounded-full bg-indigo-500"></div> Detail Modal & Live Search
                                </div>
                            </div>
                        </div>
                        <div
                ...
                <div
                    ...
                    <div>
                        <span class="text-purple-600 font-bold text-sm">Modul 02</span>
                        <h3 class="text-2xl font-bold dark:text-white mt-2 mb-4">Workflow Micro-Step</h3>
                    ...
                    <div class="mt-8 space-y-4">
                        <div
                            ...
                            <span class="text-xs font-bold dark:text-white uppercase">Estimasi</span>
                            <span
                                class="text-xs bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-400 px-2 py-1 rounded">1j
                                30m</span>
                        </div>
                        <div class="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl flex items-center justify-between">
                            <span class="text-xs font-bold dark:text-white uppercase">Audit</span>
                            <span class="text-xs text-red-500 font-bold italic">Overdue!</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        <span class="text-indigo-400 font-bold text-sm">Modul 03</span>
                        <h3 class="text-3xl font-bold mt-2 mb-6 leading-tight">Reporting <br />Engine Pro</h3>
                        <p class="text-zinc-400 text-sm leading-relaxed mb-8">
                            Hasilkan laporan formal PDF (Landscape) atau data mentah Excel untuk kebutuhan evaluasi
                            performa bulanan dengan sekali klik.
                        </p>
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-sm font-bold group-hover:text-indigo-300 transition-colors">Data
                                Rekapitulasi</span>
                        </div>
                    </div>
                    <div
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-10">
                        <div class="space-y-6">
                            <h4 class="text-xl font-bold dark:text-white">Hierarki & Keamanan</h4>
                            <p class="text-sm text-zinc-500 dark:text-zinc-400 max-w-xs">Pengaturan peran Parent-Child
                                untuk memisahkan wewenang antara Admin/Manager dan Staff.</p>
                        ...
                        <div class="flex-1 space-y-3">
                            <div
                                ...
                                <div
                                    class="w-8 h-8 bg-green-500/10 text-green-500 rounded-lg flex items-center justify-center">
                                    ✔</div>
                                <span class="text-xs font-bold dark:text-zinc-300">Guest Access Support</span>
                            </div>
                            <div
                                class="p-4 bg-white dark:bg-zinc-800/30 rounded-2xl border border-zinc-200 dark:border-zinc-700 flex items-center gap-4">
                                <div
                                    class="w-8 h-8 bg-indigo-500/10 text-indigo-500 rounded-lg flex items-center justify-center">
                                    ☾</div>
                                <span class="text-xs font-bold dark:text-zinc-300">Native Dark Mode Support</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-12">
                        <div class="flex-1">
                            <h3 class="text-2xl font-bold dark:text-white mb-4">Spesifikasi Teknis</h3>
                            <p class="text-zinc-500 dark:text-zinc-400">Dibangun dengan teknologi modern untuk performa
                                maksimal pada infrastruktur shared hosting maupun cloud.</p>
                        </div>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-8 w-full md:w-auto">
                            ...
                            <div class="text-center group-hover:scale-110 transition-transform animation-delay-500">
                                <div class="text-2xl font-black dark:text-white">Hosting</div>
                                <div class="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">Shared
                                    Ready</div>
                            </div>
                            <div class="text-center group-hover:scale-110 transition-transform animation-delay-1000">
                                <div class="text-2xl font-black dark:text-white">Full</div>
                                <div class="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">
                                    Responsive</div>
                            </div>
                        </div>
        ...
        <footer class="relative z-30 max-w-3xl mx-auto pb-40 text-center px-8 select-none">
            <h4 class="text-2xl font-bold dark:text-white mb-8">Sudah siap bertransformasi?</h4>
